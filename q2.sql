...
from ( select question_id, hint from questions as q  left join MC_incorrect_answers as m 
                                                                                                   on q.question_id = m.quest_id
          union 
          select question_id, hint from questions as q  left join NUM_incorrect_answers as n 
