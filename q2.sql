...
from ( select questions.question_id, m.hint from questions as q  join MC_incorrect_answers as m 
                                                                                                   on q.question_id = m.quest_id
          union 
          select questions.question_id, n.hint from questions as q  join NUM_incorrect_answers as n 
